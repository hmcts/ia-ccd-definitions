...
test.describe('Legal Admin creates Non-Detained Appellant in Person ' + typeOfAppeal + (isRehydrated ? 'Rehydrated ' : 'Paper ') + (inTime ? 'In Time ' : 'Out of Time ') + 'ICC Case.' , { tag: '@LegalAdminCreatesNonDetainedAppellantInPersonICC' }, () => {
