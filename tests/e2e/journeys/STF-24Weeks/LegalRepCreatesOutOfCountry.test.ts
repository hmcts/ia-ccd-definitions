...
let caseId: string = '';
const outOfCountryDecision: string = 'refusalOfHumanRights';

test.describe.configure({ mode: 'serial'});
test.describe('Create Out of Country Appeal as Legal Representative', { tag: '@STF_LegalRepCreatesOutOfCountry11' }, () => {
    ...
    test('Create Out of Country Appeal', async ({ page }) => {
        ...
        if (outOfCountryDecision === 'refusalOfHumanRights') {
