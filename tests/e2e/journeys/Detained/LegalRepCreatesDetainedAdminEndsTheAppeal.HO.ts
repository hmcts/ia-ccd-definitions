...
test.describe('Legal Rep creates Detained ' + typeOfAppeal + ' Appeal ' + (inTime ? 'In Time' : 'Out of Time' + ' Admin then ends the appeal'), { tag: '@LegalRepCreatesRepresentedAdminEndsTheAppeal' }, () => {
