...
const fileName = path.join(__dirname, '../definitions/appeal/json/AuthorisationCaseField.json');
const fileNameBail = path.join(__dirname, '../definitions/bail/json/AuthorisationCaseField.json');
